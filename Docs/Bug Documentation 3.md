...
- Action: Fixed `IsOccupied` to reflect actual occupancy and added stack change subscription/unsubscription when adding/removing items so UI updates correctly (`Assets/Scripts/InventoryScripts/Slot.cs:22-27,57-148`). 
